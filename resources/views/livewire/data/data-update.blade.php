                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            <label for="first_name" class="block text-sm font-medium text-gray-700">NIK</label>
                            <input wire:model="nik" type="text" name="first_name" id="first_name"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input wire:model="nama" type="text" name="last_name" id="last_name"
